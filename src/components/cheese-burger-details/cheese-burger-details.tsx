...
export default function CheeseBurgerDetails() {
  ...
  const cheese = {
    ...
    price: 16.0,
    image: "/Image (1).png?height=320&width=400",
      quantity, // ✅ تمام كده

  }

  const handleAddToCart = () => {
    addToCart(cheese)        // ✅ أضف المنتج إلى السلة
  ...
  return (
    <div className="min-h-screen bg-zinc-900 text-white">
      ...
      <div className="relative h-80 bg-gradient-to-b from-zinc-800 to-zinc-900">
        <img
          src="/Image (1).png?height=320&width=400&text=Cheese+Burger"
          alt="Cheese burger"
        ...
        <div className="absolute bottom-4 left-4">
          <h1 className="text-2xl font-bold text-white">Cheese burger</h1>
        </div>
      </div>
      ...
      <div className="px-4 py-6 space-y-6">
        ...
        <p className="text-zinc-300 leading-relaxed">
          ...
          carrots), spicy dipping sauce, black sandwich bun
        </p>
